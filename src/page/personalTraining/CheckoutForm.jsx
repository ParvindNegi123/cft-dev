...
const CheckoutForm = ({ paymentType, setPaymentPage, setName, name, setEmail, email, paymentIntent }) => {
    ...
    const handleSubmit = async (e) => {
        ...
        const result = await stripe.confirmPayment({
            elements,
            confirmParams: {
                return_url: `${CLIENT_BASE_URL}/services/pament/confirm`,
            },
        });
    ...
    return (
        <div className="flex justify-center">
            <div className="flex justify-center bg-theme-blue p-10 w-[40vw]">
                {paymentDone ? (
                    <div class="">
                    ...
                    <form id="payment-form" onSubmit={handleSubmit}>
                        {(paymentType === 50) ? (
                            <div className="mb-8 flex justify-center">
                                <div>
                                    <h2 className="text-2xl text-center tracking-tight font-bold text-gray-400 dark:text-white">$ 50</h2>
                                    <h2 className="text-4xl tracking-tight font-bold text-gray-500 dark:text-white">ONE SESSION</h2>
                                </div>
                            </div>
                        ) : ((paymentType === 180) ? (
                            <div className="mb-8 flex justify-center">
                                <div>
                                    <h2 className="text-2xl text-center tracking-tight font-bold text-gray-400 dark:text-white">$ 180</h2>
                                    <h2 className="text-4xl tracking-tight font-bold text-gray-500 dark:text-white">FOUR SESSIONS</h2>
                                </div>
                            </div>
                        ) : (
                            (
                                <div className="mb-8 flex justify-center">
                                    <div>
                                        <h2 className="text-2xl text-center tracking-tight font-bold text-gray-400 dark:text-white">$ 400</h2>
                                        <h2 className="text-4xl tracking-tight font-bold text-gray-500 dark:text-white">TEN SESSIONS</h2>
                                    </div>
                                </div>
                            )
                        ))
                        ...
                        <div className="my-3 text-left">
                            <label htmlFor="garminUserId" className="text-left text-gray-200">
                                Name On Card
                            </label>
                            <input
                                id="garminUserId"
                    ...
                    /> */}
                        ...
                        <div className="flex justify-center">
                            <button onClick={() => setPaymentPage(false)} className="my-6 inline-flex w-40 items-center justify-center rounded text-sm tracking-wide text-white text-opacity-80 outline-none ring-offset-2 transition hover:text-opacity-100">
                                Go Back
                            </button>
                        </div>
