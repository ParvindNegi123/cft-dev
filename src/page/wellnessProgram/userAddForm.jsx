    ...
    return (
        <>
            <div className="bg-theme-blue h-screen">
                <div className="text-gray-200 text-center text-2xl font-semibold pt-12">User Invite</div>
                        ...
                        <div className="rounded-md shadow-sm">
                            <div className="my-2">
                                ...
                                <input
                                    ...
                                    name="firstName"
                                    type="text"
                                    className="bg-theme-blue-secondary autofill:bg-slate-800 relative block w-full appearance-none border border-gray-400 px-3 py-2 text-slate-200 placeholder-gray-200 focus:z-10 focus:border-gray-400 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                ...
                <div className="my-6 flex justify-center">
                    <button onClick={() => addNewUser()} type="button" className="button-theme font-medium rounded-lg text-sm px-5 py-2.5 text-center mr-2 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800 inline-flex items-center">
                        {loading && (
