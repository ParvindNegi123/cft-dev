...
const CompanySignUp = () => {
    ...
    const verifyUser = () => {
        ...
        setLoading(true);
        axios({
            url: `${BASE_URL}/auth/invite/company/${params?.token}`, //your url
            method: 'get'
        }).then((res) => {
            setLoading(false);
            let userData = res?.data?.data;
            setCustomerForm({ companyName: userData?.companyName, personInCharge: userData?.personInCharge, email: userData?.email, typeOfCompany: userData?.typeOfCompany })
        }).catch((err) => {
                            ...
                            <div className="flex items-center justify-center py-8">
                                <form style={{ zIndex: '80000' }} className="md:w-[40vw] w-[80vw]" action="#" method="POST">
                                    ...
                                    <div className="rounded-md">
                                        ...
                                        <div className="text-center mb-2 text-gray-400">No Of Employee</div>
                                        <ul class="text-sm font-medium text-center text-gray-400 border border-gray-400 divide-x divide-gray-400 shadow sm:flex dark:divide-gray-700 dark:text-gray-400">
                                            <span class="w-full">
                                                <span
                                                    ...
                                                    className={`cursor-pointer ${(customerForm?.employeeRange === "small") && 'bg-theme-blue-secondary text-gray-300'} inline-block w-full p-4 dark:bg-gray-700 dark:text-white`}
                                                >
                                                    1-9999
                                                </span>
                                            </span>
                                            <span class="w-full">
                                                <span
                                                    ...
                                                    className={`cursor-pointer ${(customerForm?.employeeRange === "medium") && 'bg-theme-blue-secondary text-gray-300'} inline-block w-full p-4 rounded-r-lg hover:text-gray-700 hover:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700`}
                                                >
                                                    10k-99999
                                                </span>
                                            </span>
                                            <span class="w-full">
                                                <span
                                                    ...
                                                    className={`cursor-pointer ${(customerForm?.employeeRange === "big") && 'bg-theme-blue-secondary text-gray-300'} inline-block w-full p-4 rounded-r-lg hover:text-gray-700 hover:text-gray-400 dark:bg-gray-800 dark:hover:bg-gray-700`}
                                                >
                                                    Above 100k
                                                </span>
                                            </span>
                                        ...
                                        <div className="my-2">
                                            <label htmlFor="expectedCftUser" className="sr-only">Expected CFT User</label>
                                            <input
                                                value={customerForm?.expectedCftUser}
                                                onChange={(e) => setCustomerForm({ ...customerForm, expectedCftUser: e.target.value })}
                                                id="expectedCftUser"
                                                type="number"
                                                required
                                                className="bg-theme-blue autofill:bg-slate-800 relative block w-full appearance-none border border-[#2d3d5c] px-3 py-2 text-gray-300 placeholder-gray-600 focus:z-10 focus:border-gray-400 focus:outline-none focus:ring-indigo-500 sm:text-sm"
                                                placeholder="Expected CFT User"
                                            />
                                        </div>
                                        <div className="my-2">
